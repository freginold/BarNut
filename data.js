...
var terms = [],
    ...
    electrolytesTxt = "Has electrolytes",
    nonStarchVegTxt = "Non-starchy vegetable",
    leanProteinTxt = "Lean protein",
    lowCarbTxt = "Low carb",
    pureeIfPureedTxt = "OK for Pureed stage, if you puree it",
    softFoodsTxt = "OK for Soft Foods stage",
    ...
    // neutral msgs
    deliMeatProteinTxt = "3oz = 15-21g protein",
    discTxt = "DISCONTINUED",
    eggProteinTxt = "1 egg = 6g protein",
    fishProteinTxt = "3oz = 21g protein",
    ...
    leanMeatProteinTxt = "3oz = 25g protein",
    satFat5gTxt = "If < 5g of saturated fat per serving",
    shellfishProteinTxt = "3oz = 18g protein",
    ...
    moderationTxt = "OK in moderation",

    // bad msgs
    avoidForeverTxt = "Avoid forever",
    avoidForeverSugarTxt = "Made with sugar - avoid forever",
    avoidForeverCarbonatedTxt = "Carbonated - avoid forever",
    starchTxt = "Starch",
    ...
    "Atkins Lift Protein Water", gI, [clearLiquidTxt],
    ...
    "bagel", bI, [highCarbTxt],
    "Bai coconut water", gI, [zeroCalTxt, electrolytesTxt],
    "Bai water", gI, [],
    "Bariatric Advantage High Protein Meal Replacement Drink Mix", gI, [],
    "Bariatric Advantage Protein Powder", gI, [],
    "Bariwise Cereal", gI, [lowCarbTxt],
    "BBQ sauce (sugar free)", gI, [],
    "bean (not incl. string/green bean)", bI, [starchTxt],
    "beef (ground sirloin, ground lean, round, flank, tenderloin arm, pot roast, sirloin steak, sirloin tip, rump roast)", gI, [leanMeatProteinTxt],
    "beef jerky", gI, [sugar5gTxt],
    "beets", gI, [],
    "Better Than Good Protein Puffs", gI, [lowCarbTxt],
    "Blaze Keto Pizza (11\", 1 slice)", gI, [],
    "Body Fortress protein powder", gI, [],
    ...
    "carbonated beverages", bI, [avoidForeverTxt],
    ...
    "deli meat (turkey, chicken, ham, roast beef)", gI, [deliMeatProteinTxt],
    "Designer Whey 2 Go Protein Water", gI, [clearLiquidTxt],
    ...
    "Dymatize ISO 100 Clear protein water", gI, [],
    "Dymatize ISO 100 protein powder", gI, [],
    "eggplant", gI, [nonStarchVegTxt],
    "egg (raw)", gI, [leanProteinTxt, eggProteinTxt],
    "egg (hard-boiled)", gI, [leanProteinTxt, eggProteinTxt],
    "egg substitute", gI, ["1/4 cup = 6g protein"],
    ...
    "Fairlife chocolate milk", bI, [highSugarTxt],
    ...
    "filet mignon", gI, ["Typically very lean"],
    ...
    "fruit (any)", nI, [moderationTxt, fiberTxt, "pair with protein to fill you up"],
    "fruit cup", gI, [sugar15gTxt],
    "fruit juice", bI, [highSugarTxt],
    "fruit products", gI, [sugar15gTxt],
    "fruit punch", bI, [avoidForeverSugarTxt, highSugarTxt],
    ...
    "Gatorade", bI, ["Only Gatorade Zero is sugar-free"],
    "Gatorade G2", bI, ["Not approved"],
    "Gatorade Super Shake", bI, [highSugarTxt, "Good except for the sugar"],
    "Gatorade Zero", gI, [sugFreeTxt, electrolytesTxt],
    ...
    "lamb (leg roast, loin chop)", gI, [leanProteinTxt],
    "LC Foods Fresh Baked NY Style Bagels", gI, [lowCarbTxt],
    "leek", gI, [nonStarchVegTxt],
    "lemonade", bI, [avoidForeverSugarTxt],
    "lemonade (diet)", gI, [],
    ...
    "milk", gI, ["fat free, skim, 1%", sugar15gTxt],
    ...
    "nut", bI, [highFatTxt],
    "oatmeal", bI, [starchTxt, highCarbTxt, noProteinTxt, "OK after 6 months if add protein (no longer in starch free)", "Only 2-3 times per week if trying to lose weight"],
    "oats", bI, [starchTxt],
    ...
    "potato", bI, [starchTxt],
    "pork (pork chops, pork roast, any cuts from the loin)", gI, [leanProteinTxt],
    "Power Crunch Protein Energy Bar", gI, [],
    "Powerade Zero", gI, [electrolytesTxt, zeroCalTxt],
    "Premier Clear Protein Water", gI, [clearLiquidTxt],
    "Premier Protein shake", bI, [notIsolateTxt],
    "Primal Kitchen Salad Dressing", gI, [],
    "Protein 2 O", gI, [clearLiquidTxt],
    "Protein One Protein Bar", gI, ["Low in protein"],
    "Propel", gI, [zeroCalTxt, electrolytesTxt],
    ...
    "Protein2O", gI, [],
    "ProtiDiet Oatmeal", gI, [lowCarbTxt, softFoodsTxt, pureeIfPureedTxt],
    "pumpkin", gI, [ifNoAddedSugarTxt, nonStarchVegTxt, "Higher-carb vegetable but OK"],
    "Pure Protein Bar", gI, [],
    "Puritan's `Pri`de vegan protein powder", gI, [],
    "Quaker Select Starts Fiber & Protein Instant Oatmeal", bI, [starchTxt, highCarbTxt],
    ...
    "Red Bull (Diet)", bI, [avoidForeverCarbonatedTxt],
    "rice", bI, [starchTxt],
    ...
    "seltzer", bI, [avoidForeverCarbonatedTxt],
    "shallots", gI, [nonStarchVegTxt],
    "shellfish (crab, shrimp, clams, mussels, lobster, scallops, etc.)", gI, [leanProteinTxt, shellfishProteinTxt],
    "shirataki noodles", gI, [lowCarbTxt],
    "shirataki rice", gI, [lowCarbTxt],
    "Shrewd Food Protein Crisps", gI, [lowCarbTxt],
    "Simple Girl Salad Dressing", gI, [],
    ...
    "tea (decaf)", gI, [],
    "tea (herbal)", gI, [],
    "tea (sweet)", bI, [avoidForeverSugarTxt, highSugarTxt],
    "tea (with caffeine)", gI, [after1monthTxt],
    "tempeh", gI, [leanProteinTxt, "1/4 cup = 15g protein"],
    "Thin Slim Zero Carb Bread", gI, [lowCarbTxt],
    "tofu", gI, [leanProteinTxt, "1/4 cup = 10g protein"],
    "tomatillo", gI, [nonStarchVegTxt],
    "tomato (fresh, canned)", gI, [nonStarchVegTxt],
    "tonic", bI, [avoidForeverCarbonatedTxt],
    ...
    "Textured Vegetable Protein (TVP)", gI, ["1/4 cup = 12g protein"],
    ...
    "veal (cutlet, leg, loin, rib shank, shoulder)", gI, [leanProteinTxt],
    "Veggiecraft Farms Pasta", bI, [highCarbTxt, starchTxt],
    "Vitamin Water Zero", gI, [clearLiquidTxt, zeroCalTxt, electrolytesTxt],
    "Walden Farms (all products)", gI, ["Bariatric friendly"],
    "Walden Farms Calorie Free Salad Dressing", gI, [],
    ...
    "wild game (venison, buffalo, elk)", gI, [leanProteinTxt, leanMeatProteinTxt],
