...
var terms = [],
    ...
    "canned/packaged fruit in own juice", gI, ["If < 15g sugar per serving"],
    ...
    "protein bar", nI, [isolateTxt],
    "protein powder", gI, [leanProteinTxt],
    "protein shake (ready-made)", nI, [isolateTxt],
